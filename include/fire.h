...
class FireEffectSmooth
{
  protected:
    ...
    const float IGNITION_KNOB = 50.0f;  // Preference-based constant factor for ignition rate originally 50.0f
    const float SPREADRATE_KNOB = 10.0f; // Preference-based constant for flame spread rate originally 12.0f
    const float SPARKRATE_KNOB  = 8.0f; // Preference-based constant for spark ignition rate originally 8.0f
